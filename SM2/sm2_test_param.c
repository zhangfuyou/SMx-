...
char *message = "encryption standard";			//待加密的消息
char *message_digest = "message digest";		//待签名的消息

char *ID_A = "ALICE123@YAHOO.COM";				//用户A的身份
char *ID_B = "BILL456@YAHOO.COM";				//用户B的身份
